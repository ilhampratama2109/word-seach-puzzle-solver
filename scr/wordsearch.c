...
int main(){
    ...
    char filename[50], keyname[50];
    
    /*inisialisasi matcher*/
    InitMatched(match);
    printf("masukkan nama file puzzle (e.x. puzzle1.txt) : \n");
    scanf("%s", &filename);
    printf("masukkan nama file kata yang dicari (e.x. key1.txt) : \n");
    scanf("%s", &keyname);
